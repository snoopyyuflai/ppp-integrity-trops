...
filter.PARAMS.tropModel = 'NoDelay';
...
%%
% process trops
solutionSep.aivFilter.tropsAvg = solutionSep.aivFilter.tropsAvg(1:end-3);
% save NoDelay outdata
...
NoDelay_epochs_filename = 'D:\PHD_Research\output\NoDelay_epoch.mat';
NoDelay_pos_all = cat(2, outData.pos);
NoDelay_pl_all  = cat(2, outData.pl);
NoDelay_trops_all  = solutionSep.aivFilter.tropsAvg;
NoDelay_epoch_all  = cat(2, outData.epoch);
save(NoDelay_pos_filename,'NoDelay_pos_all');
save(NoDelay_pl_filename,'NoDelay_pl_all');
save(NoDelay_trops_filename,'NoDelay_trops_all');
save(NoDelay_epochs_filename,'NoDelay_epoch_all');
