...
filenameGnss = '.\data\swift-gnss-20200312-093212.obs';
...
netrcFile = '.\..\Access\cddislogin.netrc'; % change to your directory
% cddis also requires a cookie file when using cURL, see [1]
cookieFile = '.\..\Access\cddislogin.netrc'; % change to your directory
