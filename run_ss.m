...
%%
% save GPT2W outdata
UNB3_pos_filename = 'D:\PHD_Research\output\GPT2W_pos.mat';
UNB3_pl_filename = 'D:\PHD_Research\output\GPT2W_pl.mat';
UNB3_pos_all = cat(2, outData.pos);
UNB3_pl_all  = cat(2, outData.pl);
save(UNB3_pos_filename,'GPT2W_pos_all');
save(UNB3_pl_filename,'GPT2W_pl_all');
